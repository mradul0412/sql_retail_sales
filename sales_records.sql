...
---FOR COUNT THE TOP 10 ROWS 
SELECT * FROM retail_sales
LIMIT 10

-- FOR COUNT THE TOTAL NUMBER OF ROWS
SELECT 
	COUNT(*)
FROM retail_sales;
...
--DELETE ALL NULL VALUES FROM TABLES 
...
--Q.2 Write a SQL query to retrieve all transactions where the category is 'Clothing' and the quantity is sold is more than 10 in the month of Nov-2022
SELECT *
FROM retail_sales
